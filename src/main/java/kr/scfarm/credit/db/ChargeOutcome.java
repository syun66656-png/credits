 ...
 *
 * <p>{@code balanceBefore}/{@code balanceAfter} 는 {@link ChargeResult#PAID} 와
 * {@link ChargeResult#BALANCE_MISMATCH} 에서 <b>실측값</b>을 담는다(지급 트랜잭션 안에서 측정 —
 * 분쟁 방지 기록 및 이상 원인 파악용). 그 외 상태에서는 -1.
 */
